...
public class MonkeyLearnClient {
	private static final String API_KEY = "ee9a8393979b467dbc7851b8745518f040bcd97c";// make sure change it to your api key.
       public static void main(String[] args) {
		
		String[] textList = {
				"Elon Musk has shared a photo of the spacesuit designed by SpaceX. This is the second image shared of the new design and the first to feature the spacesuit’s full-body look.", 
				"Simon Design Engineering is seeking Structural Engineers of all levels with experience in building design. Experience with Revit and parking consulting preferred."
				};
    ...
    // list[m][n]: m is number of description and n is equal or less than 3
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		for (int i = 0; i < mlResultArray.size(); ++i) {
			...
			for (int j = 0; j < keywordsArray.size(); ++j) {
				// need to cast as the get will return a java object so need to cast 
